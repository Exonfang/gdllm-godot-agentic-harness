...
const WARNING_CAPTION := "gdllm/colors/warning_caption" ## Compaction headers and the context meter once the predicted next prompt fills the configured warning share of the model's window (GDLLMTunables.CONTEXT_METER_WARNING_PERCENT).
